...
(function (Kubernetes) {
    ...
    var KubernetesModelService = (function () {
        function KubernetesModelService() {
            ...
            this.appViews = [];
            this.appFolders = [];
            this.defaultIconUrl = Core.url("/img/icons/kubernetes.svg");
            this.fetched = false;
            this.fetch = function () {
            };
        }

...
(function (Kubernetes) {
    ...
    var KubernetesModelService = (function () {
        ...
        KubernetesModelService.prototype.findIconUrl = function (id, nameField) {
            var answer = null;
            if (id && nameField) {
            ...
            return answer || Kubernetes.defaultIconUrl;
        };
        KubernetesModelService.prototype.maybeInit = function () {
            ...
            if (this.services && this.replicationControllers && this.pods) {
                ...
                this.services.forEach(function (service) {
                    ...
                    var iconUrl = _this.findIconUrl(service.id, "serviceNames");
                ...
                this.replicationControllers.forEach(function (replicationController) {
                    ...
                    var iconUrl = _this.findIconUrl(replicationController.id, "replicationControllerNames");

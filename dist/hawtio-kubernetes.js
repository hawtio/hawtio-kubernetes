...
(function (Kubernetes) {
    ...
    Kubernetes.IDSelector = Kubernetes.controller("IDSelector", ["$scope", "$location", function ($scope, $location) {
        $scope.entityPageLink = Kubernetes.entityPageLink;
    }]);
